...
public class Employee extends BaseEntity {
    ...
    public Employee(String nip, String nama, String tanggalLahir, String passwordHash, boolean isHash) {
        ...
        // pengecekan passwordHash (untuk update tanpa mengubah password, maka isHash = true)
    ...
    public void fromDataString(String data) {
        ...
        // memastikan data yang ada pada file tidak kurang
    ...
    public static String hashPassword(String password) {
        try {
            ...
            // throw exception jika algoritma hashing tidak ditemukan
